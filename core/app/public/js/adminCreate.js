...
let nameRequest = '';
let url;
asyncawait("http://localhost/macata/core/app/src/request/module.request.php?method=create",'blur','p','data','bg-carrot').then(function(response){
	...
	moduleId.map(function(index){
		index.addEventListener("click", function(e){
			...
			if(nameRequest =='Formules'){
				url = "http://localhost/macata/core/app/src/request/formule.admin.request.php?method=create";
				...
				url = "http://localhost/macata/core/app/src/request/matiere.admin.request.php?method=create";
				...
				url = "http://localhost/macata/core/app/src/request/article.admin.request.php?method=create";
				...
				url = "http://localhost/macata/core/app/src/request/packaging.admin.request.php?method=create";
				...
				url = "http://localhost/macata/core/app/src/request/parametre.admin.request.php?method=create";
