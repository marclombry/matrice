...
class ParameterManager{
	...
	public function Read(){
		return $this->db->select('select * from parameter');
	}
	...
	public function History($auth,$post,$table,$fields,$action='create',$module='parameter'){
		...
		foreach ($_POST as $key => $value) {
			...
			if($key != 'datemodification' && $key !='datecreation' && $key !='update'){
